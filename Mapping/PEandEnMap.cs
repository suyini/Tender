...
{
    class PEandEnMap : EntityTypeConfiguration<PEandEn>
    {
        public PEandEnMap()
        {
            this.HasKey(t => t.PCourseId);
            this.ToTable("PEandEn");
            this.Property(t => t.PCourseId).HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);
            this.Property(t => t.PCourseId).HasColumnName("课程号");
            this.Property(t => t.PCourseName).HasColumnName("课程名称"); //课程名称
